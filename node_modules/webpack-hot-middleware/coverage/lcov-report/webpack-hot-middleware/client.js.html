...
<html lang="en">
<head>
    <title>Code coverage report for webpack-hot-middleware/client.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">webpack-hot-middleware/client.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">55.56% <small>(40 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">webpack-hot-middleware/</a> &#187; client.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (__resourceQuery) {
<span class="cstat-no" title="statement not covered" >  var pathMatch = /path=(.*?)(\&amp;|$)/.exec(__resourceQuery);</span>
<span class="cstat-no" title="statement not covered" >  if (pathMatch) {</span>
<span class="cstat-no" title="statement not covered" >    options.path = pathMatch[1];</span>
  }
<span class="cstat-no" title="statement not covered" >  var timeoutMatch = /timeout=(.*?)(\&amp;|$)/.exec(__resourceQuery);</span>
<span class="cstat-no" title="statement not covered" >  if (timeoutMatch) {</span>
<span class="cstat-no" title="statement not covered" >    options.timeout = parseFloat(timeoutMatch[1]);</span>
  }
<span class="cstat-no" title="statement not covered" >  var overlayMatch = /overlay=(.*?)(\&amp;|$)/.exec(__resourceQuery);</span>
<span class="cstat-no" title="statement not covered" >  if (overlayMatch) {</span>
<span class="cstat-no" title="statement not covered" >    options.overlay = overlayMatch[1] !== 'false';</span>
  }
<span class="cstat-no" title="statement not covered" >  var reloadMatch = /reload=(.*?)(\&amp;|$)/.exec(__resourceQuery);</span>
<span class="cstat-no" title="statement not covered" >  if (reloadMatch) {</span>
<span class="cstat-no" title="statement not covered" >    options.reload = reloadMatch[1] !== 'false';</span>
  }
}
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof window.EventSource !== 'function') {
...
&nbsp;
  var timer = setInterval(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    if ((new Date() - lastActivity) &gt; options.timeout) {</span>
<span class="cstat-no" title="statement not covered" >      handleDisconnect();</span>
    }
  }, options.timeout / 2);
&nbsp;
<span class="fstat-no" title="function not covered" >  function handleOnline() {</span>
<span class="cstat-no" title="statement not covered" >    console.log("[HMR] connected");</span>
<span class="cstat-no" title="statement not covered" >    lastActivity = new Date();</span>
  }
&nbsp;
  function handleMessage(event) {
    lastActivity = new Date();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (event.data == "\uD83D\uDC93") {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    try {
      processMessage(JSON.parse(event.data));
    } catch (ex) {
<span class="cstat-no" title="statement not covered" >      console.warn("Invalid HMR message: " + event.data + "\n" + ex);</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function handleDisconnect() {</span>
...
<span class="cstat-no" title="statement not covered" >    setTimeout(connect, options.timeout);</span>
  }
&nbsp;
}
&nbsp;
...
&nbsp;
var overlay;
<span class="missing-if-branch" title="else path not taken" >E</span>if (options.overlay) {
  overlay = require('./client-overlay');
}
&nbsp;
<span class="fstat-no" title="function not covered" >function problems(type, obj) {</span>
<span class="cstat-no" title="statement not covered" >  console.warn("[HMR] bundle has " + type + ":");</span>
<span class="cstat-no" title="statement not covered" >  var list = [];</span>
<span class="cstat-no" title="statement not covered" >  obj[type].forEach(<span class="fstat-no" title="function not covered" >function(msg) {</span></span>
<span class="cstat-no" title="statement not covered" >    var clean = strip(msg);</span>
<span class="cstat-no" title="statement not covered" >    console.warn("[HMR] " + clean);</span>
<span class="cstat-no" title="statement not covered" >    list.push(clean);</span>
  });
<span class="cstat-no" title="statement not covered" >  if (overlay &amp;&amp; type !== 'warnings') <span class="cstat-no" title="statement not covered" >overlay.showProblems(list);</span></span>
}
&nbsp;
function success() {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (overlay) overlay.clear();
}
&nbsp;
...
function processMessage(obj) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.action == "building") {
<span class="cstat-no" title="statement not covered" >    console.log("[HMR] bundle rebuilding");</span>
  } else if (obj.action == "built") {
    console.log("[HMR] bundle rebuilt in " + obj.time + "ms");
    <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.errors.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >      problems('errors', obj);</span>
    } else {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.warnings.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >        problems('warnings', obj);</span>
      } else {
        success();
      }
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (customHandler) {
    customHandler(obj);
  }
}
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (module) {
  module.exports = {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Sep 28 2015 11:53:49 GMT+0100 (BST)</div>
</div>
