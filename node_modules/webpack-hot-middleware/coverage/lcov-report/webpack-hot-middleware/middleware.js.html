...
<html lang="en">
<head>
    <title>Code coverage report for webpack-hot-middleware/middleware.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">webpack-hot-middleware/middleware.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">webpack-hot-middleware/</a> &#187; middleware.js</div>
</div>
<div class="body">
...
function webpackHotMiddleware(compiler, opts) {
  ...
  opts.log = typeof opts.log == 'undefined' ? <span class="branch-0 cbranch-no" title="branch not covered" >console.log </span>: opts.log;
  opts.path = opts.path || '/__webpack_hmr';
  opts.heartbeat = opts.heartbeat || 10 * 1000;
&nbsp;
  var eventStream = createEventStream(opts.heartbeat);
  compiler.plugin("compile", function() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (opts.log) opts.log("webpack building...");
    eventStream.publish({action: "building"});
  });
  compiler.plugin("done", function(stats) {
    stats = stats.toJson();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (opts.log) {
  ...
  var middleware = function(req, res, next) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!pathMatch(req.url, opts.path)) <span class="cstat-no" title="statement not covered" >return next();</span>
...
function createEventStream(heartbeat) {
  ...
  return {
    handler: function(req, res) {
      ...
      var id = clientId++;
      clients[id] = res;
      req.on("close", <span class="fstat-no" title="function not covered" >function(){</span>
...
function buildModuleMap(modules) {
  var map = {};
  modules.forEach(<span class="fstat-no" title="function not covered" >function(module) {</span>
